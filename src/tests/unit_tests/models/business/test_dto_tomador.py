...
class TestTomadorExtractedInfo(BasePydanticModelTest):
    """
    This class is used to test the TomadorExtractedInfo model.
    ...
    def get_model(self):
        return dtoTomador.TomadorExtractedInfo
    ...
    def test_create_without_cpf_and_cnpj_raises_error(self):
        """
        As defined in the model, the tomador must have at 
...
class TestTomadorFormattedInfo(BasePydanticModelTest):
    """
    This class is used to test the TomadorFormattedInfo model.
    It inherits from BasePydanticModelTest, which provides the basic functionality for testing Pydantic models.
    If it pass, it means that the model is working as expected:
        * the optional fields are not raising errors when not provided
        * the required fields are raising errors when not provided
    ...
    def get_model(self):
        return dtoTomador.TomadorFormattedInfo
