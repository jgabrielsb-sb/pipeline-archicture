...
from packag.modules.pipeline.operations.extractors.fileToNotaExtractor.arapiracaFileToNotaExtractor import ArapiracaFileToNotaExtractor
...
NOTAS = [
    (
        ...
        {
            "numero_nfs": "205",
            "codigo_autenticidade": "359E.6DC6.7425",
            "data_competencia": "03/05/2025",
            ...
            "discriminacao_servico": "Contrato 00505/25 AE 394483 item 0001",
            "opt_simples_nacional": "1",
            "serie": None,
            "nfse_substituida": None,
            "valor_outras_retencoes": "0,00",
            "data_emissao": "03/05/2025 - 04:18:25",
            "atv_economica": "17.01",
            "municipio": "Arapiraca"
        }
    ...
    (
        ...
        {
            "numero_nfs": "694",
            "codigo_autenticidade": "AC8E.3050.A2B4",
            "data_competencia": "02/05/2025",
            "valor_liquido": "2.523,04",
            "valor_total": "2.600,00",
            "valor_deducoes": "0,00",
            "valor_pis": "0,00",
            "valor_cofins": "0,00",
            "valor_inss": "0,00",
            ...
            "valor_csll": "0,00",
            "valor_issqn": "76,96",
            "base_calculo": "2.600,00",
            "aliquota": "2,96",
            "issqn_a_reter": "1",
            "estado": "AL",
            "codigo_tributacao": "8.02",
            "discriminacao_servico": "Contrato 00553/25 AE 395148 item 0001",
            "opt_simples_nacional": "1",
            "serie": None,
            "nfse_substituida": None,
            "valor_outras_retencoes": "0,00",
            "data_emissao": "02/05/2025 - 10:10:02",
            "atv_economica": "8.02",
            "municipio": "Arapiraca"
        }
    ...
    (
        ...
        {
            "numero_nfs": "1008",
            "codigo_autenticidade": "581E.A315.A074",
            "data_competencia": "02/05/2025",
            "valor_liquido": "4.503,12",
            "valor_total": "4.640,00",
            "valor_deducoes": "0,00",
            "valor_pis": "0,00",
            "valor_cofins": "0,00",
            "valor_inss": "0,00",
            ...
            "valor_csll": "0,00",
            "valor_issqn": "136,88",
            "base_calculo": "4.640,00",
            "aliquota": "2,95",
            "issqn_a_reter": "1",
            "estado": "AL",
            "codigo_tributacao": "17.01",
            "discriminacao_servico": "contrato 00440/25 AE 394001 item 0001",
            "opt_simples_nacional": "1",
            "serie": None,
            "nfse_substituida": None,
            "valor_outras_retencoes": "0,00",
            "data_emissao": "02/05/2025 - 10:59:40",
            "atv_economica": "17.01",
            "municipio": "Arapiraca"
        }
...
def test_if_all_extractor_methods_are_returning_the_correct_value(xml_filename, expected):
    ...
    extractor = ArapiracaFileToNotaExtractor(dto_file)
...
def test_if_extract_data_raise_extract_method_error_when_extract_text_from_pdf_raises_filenotfounderror():
    ...
    extractor = ArapiracaFileToNotaExtractor(MagicMock())
