...
from packag.modules.pipeline.operations.extractors.fileToTomadorExtractor.delmiroFileToTomadorExtractor import (
    DelmiroFileToTomadorExtractor
)
...
def test_if_all_extractor_methods_are_returning_the_correct_value(xml_filename, expected):
    ...
    extractor = DelmiroFileToTomadorExtractor(dto_file)
...
def test_if_extract_data_raise_extract_method_error_when_extract_text_from_pdf_raises_filenotfounderror():
    ...
    extractor = DelmiroFileToTomadorExtractor(MagicMock())
