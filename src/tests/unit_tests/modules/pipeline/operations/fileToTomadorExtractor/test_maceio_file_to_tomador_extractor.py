...
from packag.modules.pipeline.operations.extractors.fileToTomadorExtractor.maceioFileToTomadorExtractor import (
    MaceioFileToTomadorExtractor
)
...
PRESTADORES = [
    (
        "21.xml",
        {
            ...
            "cep": "57020565",
            "telefone": "8240091600",
            "email": "nivaldo@al.sebrae.com.br"
        }
...
def test_if_all_extractor_methods_are_returning_the_correct_value(xml_filename, expected):
    ...
    extractor = MaceioFileToTomadorExtractor(dto_file)
...
def test_if_extract_data_raise_extract_method_error_when_extract_text_from_pdf_raises_filenotfounderror():
    ...
    extractor = MaceioFileToTomadorExtractor(MagicMock())
