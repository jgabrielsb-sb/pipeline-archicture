...
from packag.modules.pipeline.operations.extractors.fileToPrestadorExtractor.maceioFileToPrestadorExtractor import (
    MaceioFileToPrestadorExtractor
)
...
PRESTADORES = [
    (
        "21.xml",
        {
            "cnpj": "47897413000184",
            "cpf": None,
            "inscricao_municipal": "901627745",
            "razao_social": "HAVANSO LTDA",
            "endereco": "999 Professor Graça Leite",
            "numero": "113",
            ...
            "cep": "57052520",
            "telefone": "8198942707",
            "email": "thaysluciana.adv@gmail.com"
         }
    ...
    (
        "160.xml",
        {
            "cnpj": "31997427000130",
            "cpf": None,
            "inscricao_municipal": "901444590",
            "razao_social": "DANIELA MARQUES TENORIO GOMES 04861966400",
            "endereco": "MANOEL DE OMENA FIREMAN",
            "numero": "174",
            "bairro": "PINHEIRO",
            "municipio": "2704302",
            "uf": "AL",
            "cep": "57057210",
            "telefone": None,
            "email": "danika_marques@hotmail.com"
            }
    ...
    (
        "405.xml",
        {
            "cnpj": "14876384000115",
            "cpf": None,
            "inscricao_municipal": "901112879",
            "razao_social": "RC MARCAS E PATENTES LTDA",
            "endereco": "MELO PÓVOAS",
            "numero": "110",
            "bairro": "JARAGUÁ",
            "municipio": "2704302",
            "uf": "AL",
...
def test_if_all_extractor_methods_are_returning_the_correct_value(xml_filename, expected):
    ...
    extractor = MaceioFileToPrestadorExtractor(dto_file)
...
def test_if_extract_data_raise_extract_method_error_when_extract_text_from_pdf_raises_filenotfounderror():
    ...
    extractor = MaceioFileToPrestadorExtractor(MagicMock())
