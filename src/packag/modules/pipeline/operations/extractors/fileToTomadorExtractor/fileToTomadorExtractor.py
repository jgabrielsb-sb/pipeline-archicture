...
class FileToTomadorExtractor(Operation, ABC):
    """
    ...
    The output is a dtoTomador.TomadorExtractedInfo object.
    ...
    def validate_output(self, output_data: dict):
        ...
        If the output data is not a dtoTomador.TomadorExtractedInfo object, a ValidationError is raised.
        If the output data is a dtoTomador.TomadorExtractedInfo object, it is returned.
        """
        ...
        if not isinstance(output_data, dict):
            message = ValidationErrorMessage(
                ...
                expected_type=str(type(dtoTomador.TomadorExtractedInfo)),
            )
        ...
        try:
            return dtoTomador.TomadorExtractedInfo(**output_data)
    ...
    def run(self, input_data: dtoFile):
        ...
        try:
            ...
            tomador = self.validate_output(output_data)
            return tomador
        except (
            ValidationError, 
            GetAllExtractedInfoError
